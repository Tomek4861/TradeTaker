...
public class ApiExceptionHandler {
    ...
    private ResponseEntity<StandardResponse<Void>> body(HttpStatus status, String message) {
        return ResponseEntity.status(status).body(StandardResponse.error(message));
    }

    @ExceptionHandler(CalculationException.class)
    public ResponseEntity<StandardResponse<Void>> handleCalculation(CalculationException ex) {
    ...
    public ResponseEntity<StandardResponse<Void>> handleConstraint(ConstraintViolationException ex) {
    ...
    public ResponseEntity<StandardResponse<Void>> handleBadParameters(HandlerMethodValidationException ex) {
    ...
    public ResponseEntity<StandardResponse<Void>> handleBadRequest(Exception ex) {
        logger.warn("Bad request: {}", ex.getMessage());
        return body(HttpStatus.BAD_REQUEST, "Invalid request parameters");
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<StandardResponse<Void>> handleBadJson(HttpMessageNotReadableException ex) {
    ...
    public ResponseEntity<StandardResponse<Void>> handleMethodNotAllowed(HttpRequestMethodNotSupportedException ex) {
